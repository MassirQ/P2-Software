...
function createUpdateAndParams({ updateInput, varName, node, parentVar, chainStr, insideDoWhen, withVars, context, parameterPrefix, includeRelationshipValidation, }) {
                ...
                updates.forEach((update, index) => {
                    ...
                    if (update.update) {
                        ...
                        if (update.update.edge) {
                            subquery.push(`CALL apoc.do.when(${relationshipVariable} IS NOT NULL, ${insideDoWhen ? '\\"' : '"'}`);

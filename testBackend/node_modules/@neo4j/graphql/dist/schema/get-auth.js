...
const validOperations = ["CREATE", "READ", "UPDATE", "DELETE", "CONNECT", "DISCONNECT"];
const validFields = [
    "operations",
    "AND",
    "OR",
...
function getAuth(directive) {
    ...
    const rules = (_a = directive.arguments) === null || _a === void 0 ? void 0 : _a.find((x) => x.name.value === "rules");
    if (!rules) {
